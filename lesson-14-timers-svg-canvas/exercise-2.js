...
function createSecondArrow(arrowWidth, arrowLength, degree) {
  context.beginPath();
...
function createMinuteArrow(arrowWidth, arrowLength, degree) {
  context.beginPath();
  context.strokeStyle = 'black';
  context.lineWidth = arrowWidth;
  context.moveTo(baseCenter, baseCenter);
...
function createHourArrow(arrowWidth, arrowLength, degree) {
  context.beginPath();
  context.strokeStyle = 'black';
  context.lineWidth = arrowWidth;
  context.moveTo(baseCenter, baseCenter);
...
function updateWatch(hour, minute, second) {
  ...
  createHourArrow(6, 100, thisHourRotate);
  createMinuteArrow(4, 110, thisMinuteRotate);
  createSecondArrow(2, 110, thisSecondRotate);
}